...
public static class LEB128
{
    ...
    public static void AddLEB128Signed(this List<byte> list, long value) => AddLEB128Signed(list, value, out _);
    
    public static void AddLEB128Signed(this List<byte> list, long value, out int bytes)
    {
        bytes = 0;
        bool more = true;
    ...
    public static void InsertLEB128Signed(this List<byte> list, int index, long value) => InsertLEB128Signed(list, index, value, out _);

    public static void InsertLEB128Signed(this List<byte> list, int index, long value, out int bytes)
    {
        bytes = 0;
        bool more = true;
    ...
    public static void InsertLEB128Unsigned(this List<byte> list, int index, ulong value) => InsertLEB128Unsigned(list, index, value, out _);

    public static void InsertLEB128Unsigned(this List<byte> list, int index, ulong value, out int bytes)
    {
        bytes = 0;
        bool more = true;
    ...
    public static void AddLEB128Unsigned(this List<byte> list, ulong value) => AddLEB128Unsigned(list, value, out _);
    
    public static void AddLEB128Unsigned(this List<byte> list, ulong value, out int bytes)
    {
        bytes = 0;
        bool more = true;
    ...
    public static byte ToLEB128Signed(byte value)
    {
        byte result = 0;
        bool more = true;
        int shift = 0;
